			...
			<div class="w-full flex flex-col gap-2.5">
				<div class="w-full">
					...
					<div class="w-full mt-1">
						<input
							class="w-full rounded-lg py-2 px-4 text-sm bg-gray-50 dark:text-white dark:bg-gray-850 outline-hidden"
							type="text"
							bind:value={name}
				...
				<div>
					...
					<div class=" w-full mt-1">
						<textarea
							class="w-full resize-none rounded-lg py-2 px-4 text-sm bg-gray-50 dark:text-white dark:bg-gray-850 outline-hidden"
							rows="4"
